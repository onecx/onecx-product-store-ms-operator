...
----
quarkus.operator-sdk.controllers.microservice.retry.max-attempts=10
quarkus.operator-sdk.controllers.microservice.retry.interval.initial=5000
quarkus.operator-sdk.controllers.microservice.retry.interval.multiplier=3
quarkus.operator-sdk.controllers.microservice.retry.interval.max=300000
...
include::onecx-product-store-ms-operator-extensions.adoc[opts=optional]
